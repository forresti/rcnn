...
% caffe('set_device', 1)
% FORREST_extract_train_test('../train_a19_stock/caffe_imagenet_train_iter_300000', 'alexnet_300k_voc_2007_trainval');

function FORREST_extract_train_test(net_file, cache_name)
...
%    rcnn_exp_cache_features('test_2', net_file, cache_name);  % chunk4
    test_results = rcnn_exp_train_and_test(net_file, cache_name)
